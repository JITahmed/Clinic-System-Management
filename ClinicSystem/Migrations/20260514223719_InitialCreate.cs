        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientReferenceNumber = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorId = table.Column<int>(type: "int", nullable: false),
                    AppointmentReferenceNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_CPRNumber",
                table: "Patients",
                column: "CPRNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Patients_PatientReferenceNumber",
                table: "Patients",
